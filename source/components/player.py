...
class Player(pygame.sprite.Sprite):
    ...
    def load_data(self):
        ...
        filr_path=os.path.join('source/data/player',file_name)
        with open(filr_path) as f:
    ...
    def load_images(self):
        ...
        self.big_file_frames=[self.right_big_fire_frames,self.left_big_fire_frames]
